...
const sequelize = new Sequelize({
  ...
  dialectOptions: {
    connectString:
      '(description=(retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1522)(host=adb.eu-frankfurt-1.oraclecloud.com))(connect_data=(service_name=g87497cc58e5ce0_thnjau6snyo3fqgp_high.adb.oraclecloud.com))(security=(ssl_server_dn_match=yes)))',
